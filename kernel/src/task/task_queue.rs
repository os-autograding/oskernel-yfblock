...
lazy_static! {
    pub static ref TASK_QUEUE: Mutex<VecDeque<&'static str>> = Mutex::new(VecDeque::from(vec![
        ...
        "busybox echo -n lat_mmap -P 1 512k /var/tmp/XXX: ",
        "lmbench_all lat_mmap -P 1 512k /var/tmp/XXX",

        "busybox echo -n bw_file_rd -P 1 512k io_only /var/tmp/XXX: ",
        "lmbench_all bw_file_rd -P 1 512k io_only /var/tmp/XXX",

        "busybox echo -n bw_file_rd -P 1 512k open2close /var/tmp/XXX: ",
        "lmbench_all bw_file_rd -P 1 512k open2close /var/tmp/XXX",

        "busybox echo -n bw_mmap_rd -P 1 512k mmap_only /var/tmp/XXX: ",
        "lmbench_all bw_mmap_rd -P 1 512k mmap_only /var/tmp/XXX",

        "busybox echo -n bw_mmap_rd -P 1 512k open2close /var/tmp/XXX: ",
        ...
        // "busybox ash -c lmbench_all lmdd label=\"File /var/tmp/XXX write bandwidth:\" of=/var/tmp/XXX move=1m fsync=1 print=3", // 暂时出问题
